...
@section('content')
            ...
            <div class="grid grid-rows-2 grid-cols-9 gap-4">
                <div class="relative col-span-9 row-span-1 md:col-span-4 card" style="height: 180px">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        <h5 class="text-lg font-semibold">Kursi</h5>
                        <span class="">{{ $jumlahKursi }} items</span>
                    </div>
                    <a href="{{ route('kursi') }}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                <div class="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
                    <div class="card-shadow rounded-xl">
                        <img src="{{asset('/frontend/images/content/category-rak.png')}}" alt=""
                            class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                    </div>
                    <div
                        ...
                        <h5 class="text-lg font-semibold">Rak</h5>
                        <span class="">{{ $jumlahRak }} items</span>
                    </div>
                    <a href="{{route('rak')}}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                <div class="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
                    <div class="card-shadow rounded-xl">
                        <img src="{{asset('/frontend/images/content/category-sofa.png')}}" alt=""
                            class="w-full h-full object-cover object-center overlay overflow-hidden rounded-xl" />
                    </div>
                    <div
                        class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12">
                        <h5 class="text-lg font-semibold">Sofa</h5>
                        <span class="">{{ $jumlahSofa }} items</span>
                    </div>
                    <a href="{{ route('kursi') }}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-4 card">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        <h5 class="text-lg font-semibold">Meja</h5>
                        <span class="">{{ $jumlahMeja }} items</span>
                    </div>
                    <a href="{{ route('meja') }}" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
            </div>
    ...
    <section class="py-16">
        ...
        <div class="container mx-auto mb-8">
            <div class="flex justify-center text-center mb-4" id="our-products">
                <h3 class="text-2xl capitalize font-semibold">
                    Our Products
                </h3>
            </div>
        </div>
        <div class="p-50 flex flex-wrap items-center justify-center ">
            @foreach ($products as $product)
            <div class="px-4 py-5 relative card group">
                <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 487px; height: 386px">
                    <div
    ...
    <div class="container mx-auto mt-4">
        <div class="flex justify-center text-center mt-4">
            <a href="{{ route('our-products') }}" class="bg-white hover:bg-black-400 text-gray-800 font-semibold py-3 px-8 border border-pink-400 rounded shadow"
                >View All</a
              >
        </div>
    </div>
    ...
    <section class="flex flex-col py-16">
        <div class="container mx-auto mb-4" id="arrived">
                ...
                @foreach ($ariveds as $arived)
                    <div class="px-4 relative card group">
                        <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                            ...
                            <img src="{{ $arived->galleries()->exists() ? Storage::url($arived->galleries->first()->url) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                                alt="" class="w-full h-full object-cover object-center" />
                        </div>
                        <h5 class="text-lg font-semibold mt-4">{{ $arived->name }}</h5>
                        <span class="">IDR {{ number_format($arived->price) }}</span>
                        <a href="{{ route('details', $arived->slug) }}" class="stretched-link">
                            <!-- fake children -->
                        </a>
                    </div>
                @endforeach
