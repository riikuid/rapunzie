      ...
      <div class="container mx-auto py-5">
        <div class="flex flex-stretch items-center">
          <div class="w-56 items-center flex">
            <a href="{{ route('index') }}">
              <img
                src="{{url('/frontend/images/content/rapunzie.png')}}"
                alt="Rapunzie | Fulfill your house with beautiful furniture"
              />
            </a>
          </div>
          ...
          <div class="w-auto">
            <ul
              class="fixed bg-white inset-5 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
              id="menu"
            >
              <li class="mx-3 py-6 md:py-0">
                <a href="our-products" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'}} hover:underline"
                  >Products</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
                <a href="/#arrived" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black'}} hover:underline"
                  >Latest</a
                >
              </li>
              <li class="mx-3 py-6 md:py-0">
