<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (Auth::user()->roles == 'ADMIN')
                        ...
                        <x-jet-nav-link href="{{ route('dashboard.reports.index') }}" :active="request()->routeIs('dashboard.user.index')">
                            {{ __('Reports') }}
                        </x-jet-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('dashboard.reports.index') }}" :active="request()->routeIs('dashboard.user.index')">
                {{ __('Reports') }}
            </x-jet-responsive-nav-link>
            @endif
